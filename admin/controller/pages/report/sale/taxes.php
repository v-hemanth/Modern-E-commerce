...
class ControllerPagesReportSaleTaxes extends AController
{
    public function main()
    {
        ...
        $grid_settings = [
            //id of grid
            'table_id'       => 'report_taxes_grid',
            // url to load data from
            'url'            => $this->html->getSecureURL('listing_grid/report_sale/taxes'),
            // default sort column
            'sortname'       => 'date_end',
        ...
        $form->setForm(
            [
                'form_name' => 'report_taxes_grid_search',
            ]
        );

        $this->data['grid_search_form'] = [];
        $this->data['grid_search_form']['id'] = 'report_taxes_grid_search';
        $this->data['grid_search_form']['form_open'] = $form->getFieldHtml(
            [
                'type'   => 'form',
                'name'   => 'report_taxes_grid_search',
                'action' => '',
            ]
        );
        ...
        $this->document->addBreadcrumb(
            [
                'href'      => $this->html->getSecureURL('report/sale/taxes'),
        ...
        $this->processTemplate('pages/report/sale/taxes.tpl');
